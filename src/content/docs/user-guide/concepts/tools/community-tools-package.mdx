...
- mongodb_memory
```python
pip install 'strands-agents-tools[mongodb-memory]'
```
...
- twelvelabs
```python
pip install 'strands-agents-tools[twelvelabs]'
```
...
- [`elasticsearch_memory`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/elasticsearch_memory.py): Agent memory backed by Elasticsearch with vector search
- [`mongodb_memory`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/mongodb_memory.py): Agent memory backed by MongoDB Atlas with vector search
...
- [`tavily_search`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/tavily.py): Search the web using Tavily's AI-powered search API
- [`tavily_extract`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/tavily.py): Extract clean, structured content from web pages using Tavily
- [`tavily_crawl`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/tavily.py): Crawl websites with configurable depth and breadth using Tavily
- [`tavily_map`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/tavily.py): Map website structure and discover URLs using Tavily
- [`exa_search`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/exa.py): Neural and keyword search across the web using Exa
- [`exa_get_contents`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/exa.py): Retrieve clean page contents from URLs using Exa
- [`bright_data`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/bright_data.py): Web scraping and search using Bright Data's scraping APIs
...
- [`mcp_client`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/mcp_client.py): Dynamically connect to MCP servers and invoke their tools at runtime
...
- [`search_video`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/search_video.py): Search through video content using TwelveLabs
- [`chat_video`](https://github.com/strands-agents/tools/blob/main/src/strands_tools/chat_video.py): Chat with video content using TwelveLabs
